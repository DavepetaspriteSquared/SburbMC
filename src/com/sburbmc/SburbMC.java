...
public class SburbMC extends JavaPlugin{
	...
	ArrayList<Player> Asleep = new ArrayList<Player>();
	ArrayList<Player> Awake = new ArrayList<Player>();
	
	ArrayList<Player> Prospit = new ArrayList<Player>();
	ArrayList<Player> Derse = new ArrayList<Player>();
